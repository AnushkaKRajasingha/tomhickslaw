...
<body <?php body_class(); ?>>
<div id="page" class="hfeed akrmod">
	<header id="branding" role="banner">
			...
			<nav id="access" role="navigation">
				...
				<div id="menu-toggle-primary">
		            <a class="open-menu-primary" href="#mobile-menu-nav"><span>Menu</span></a>
		            <a class="close-menu-primary" href="#"><span>Close Menu</span></a>
		        </div>
				<?php 
				wp_nav_menu(
						array( /*== Call Responsive menu ==*/
			...
			<hgroup>
				<h1 id="site-title"><span><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="http://tomhickslaw.com/wp-content/uploads/2015/08/tom-hicks-logo.png"></a></span></h1>
			...
			if (function_exists('putRevSlider')) {
				putRevSlider("fron_page_slider");
			}
			else 
				echo 'Please install the Revolution Slider from <a href="http://revolution.themepunch.com/" >themepunch.com</a>';			
